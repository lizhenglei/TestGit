...
@protocol rightViewScrollwDelegete <NSObject>
-(void)isNotLogin;
...
@property(nonatomic,assign)id<rightViewScrollwDelegete>delegete;
...
@property (nonatomic, strong) UINavigationController *rightViewController;

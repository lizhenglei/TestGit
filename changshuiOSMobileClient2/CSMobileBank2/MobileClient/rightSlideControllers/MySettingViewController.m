...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        UIView*bg = [[UIView alloc]initWithFrame:CGRectMake(-10, 0, tableView.frame.size.width, 44)];
        ...
        UIImage *image22 = [Context ImageName:imgeArray[indexPath.row]];
        imageView.image = image22;        //我的设置图片换肤

...
#define FOREGROUND_STAR_IMAGE_NAME @"comment_star_yellow"
#define BACKGROUND_STAR_IMAGE_NAME @"comment_star_gray"
...
//    if (tapPoint.x<(self.bounds.size.width / self.numberOfStars)) {
//        self.scorePercent = 0;
//    }
}

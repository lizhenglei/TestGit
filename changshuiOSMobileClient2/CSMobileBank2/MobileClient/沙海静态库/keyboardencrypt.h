...
+(NSString*)gFunctionOnClickEvent:(NSString*)pwdTextField maxLenPwd:(NSString*)maxLenPwd minLenPwd:(NSString*)minLenPwd timeStr:(NSMutableString*)timeStr de:(BOOL)developer;

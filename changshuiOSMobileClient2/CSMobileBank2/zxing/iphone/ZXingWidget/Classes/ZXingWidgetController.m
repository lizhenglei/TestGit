...
- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode {
    ...
    return [self initWithDelegate:scanDelegate showCancel:shouldShowCancel OneDMode:shouldUseoOneDMode showLicense:YES changeType:self.skinChangeType selectInt:self.selectInt];
}

- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode showLicense:(BOOL)shouldShowLicense changeType:(NSString *)changeType selectInt:(int)selectInt{
    self = [super init];
    if (self) {
        self.skinChangeType = changeType;//换肤
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    //    if ([self.skinChangeType isEqualToString:@"blue"]) {
    //        imageString = @"Navigation_bg_blue";
    //        skinSaoString = @"buttom_menu_center1_blue";
    //        skinTabImageSelectArray = @[@"buttom_menu1_blue",@"buttom_menu2_blue",@"buttom_menu3_blue",@"buttom_menu4_blue"];
    //    }if ([self.skinChangeType isEqualToString:@"green"]) {
    //        imageString = @"Navigation_bg_green";
    //        skinSaoString = @"buttom_menu_center1_green";
    //
    //        skinTabImageSelectArray = @[@"buttom_menu1_green",@"buttom_menu2_green",@"buttom_menu3_green",@"buttom_menu4_green"];
    //
    //    }if ([self.skinChangeType isEqualToString:@"golden"]) {
    //        imageString = @"Navigation_bg_golden";
    //        skinSaoString = @"buttom_menu_center1_golden";
    //        skinTabImageSelectArray = @[@"buttom_menu1_golden",@"buttom_menu2_golden",@"buttom_menu3_golden",@"buttom_menu4_golden"];
    //    }
    ...
    leftBtn.frame = CGRectMake(6, 15, 46/2+21, 46/2+21);
    leftBtn.tag = 100;
    ...
    rightBtn.frame = CGRectMake(self.view.bounds.size.width-56, 18+(44/2-46/4)-16, 46/2+24, 46/2+21);
...
//    [rightBtn addSubview:loginImage];
    ...
    [rightBtn setImage:[UIImage imageNamed:@"Navigation_isLogin"] forState:UIControlStateSelected];
    rightBtn.backgroundColor = [UIColor redColor];
    rightBtn.tag = 101;
    [rightBtn addTarget:self action:@selector(cancel:) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:rightBtn];
    
    UILabel *nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width/2-80, 20+(44/2-46/4), 160, 46/2)];
    nameLabel.text = @"二维码扫描";
    nameLabel.center = CGPointMake(self.view.frame.size.width/2, 38);

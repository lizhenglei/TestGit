...
- (void)createUI {
    ...
    _distanceLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.contentView.frame.size.width-100, _nameLabel.frame.size.height+_nameLabel.frame.origin.y-12, 90, 20)];

        ...
        function () {
            ...
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    scope.$watch(options.endDate,function(){
                    	test();
                    });
                    function test(){
                    	function UTCDate() {
                        ...
                        var Datetimepicker = function (element, options) {
                            ...
                            this.component = this.element.is('.date') ? this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar2').parent() : false;
                            ...
                            this.picker = vx.element(DPGlobal.template)
                                ...
                                .on({
                                    click: $.proxy(this.click, this),   //回写数据的
                                    mousedown: $.proxy(this.mousedown, this)
                                });

                            if (this.isInline) {
                                this.picker.addClass('calendar2-inline');
                            } else {
                                this.picker.addClass('calendar2-dropdown-' + this.pickerPosition + ' dropdown-menu');
                            }
                            if (this.isRTL) {
                                this.picker.addClass('calendar2-rtl');
                            ...
                            vx.element(document).on('mousedown',function (e) {
                                                   ...
                                                   if (vx.element(e.target).closest('.calendar2').length === 0) {
                                                       that.hide();
                                                   }
                                               });                                                                              
                        ...
                        Datetimepicker.prototype = {
                                ...
                                if (this.isInput) { // single input
                                    this._events = [
                                        [this.element, {
                                            ...
                                            click: $.proxy(this.show, this),//增加了点击事件不消失日历选项
                            ...
                            setStartDate: function (startDate) {
                            	...
                            	//从当前日期开始      
                                this.startDate = scope[startDate] || -Infinity;
                            ...
                            setEndDate: function (endDate) {
                            	...
                            	this.endDate = scope[endDate] || Infinity;
                            ...
                            fillDow: function () {
                                ...
                                html += '</tr>';
                                this.picker.find('.calendar2-days thead').append(html);
                            },
                            ...
                            fillMonths: function () {
                                ...
                                this.picker.find('.calendar2-months td').html(html);
                            },
                            ...
                            fill: function () {
                                ...
                                var d = new Date(this.viewDate),
                                    ...
                                    today = new Date();
                                this.picker.find('.calendar2-days thead th:eq(1)')
                                ...
                                if (this.formatViewType == "time") {
                                    ...
                                    this.picker.find('.calendar2-hours thead th:eq(1)')
                                        .text(hoursDisplay + ':' + minutesDisplay + ' ' + meridianDisplay.toUpperCase());
                                    this.picker.find('.calendar2-minutes thead th:eq(1)')
                                        .text(hoursDisplay + ':' + minutesDisplay + ' ' + meridianDisplay.toUpperCase());
                                } else {
                                    this.picker.find('.calendar2-hours thead th:eq(1)')
                                ...
                                var prevMonth = new  UTCDate(year, month - 1, 28, 0, 0, 0, 0),
                                ...
                                this.picker.find('.calendar2-days tbody').empty().append(html.join(''));

                                html = [];
                                var txt = '', meridian = '', meridianOld = '';
                                for (var i = 0; i < 24; i++) {
                                    var actual = new UTCDate(year, month, dayMonth, i);
                                    clsName = '';
                                ...
                                this.picker.find('.calendar2-hours td').html(html.join(''));
                                ...
                                this.picker.find('.calendar2-minutes td').html(html.join(''));

                                var currentYear = this.date.getUTCFullYear();
                                var months = this.picker.find('.calendar2-months')
                                    .find('th:eq(1)')
                                    .text(year)
                                    .end()
                                ...
                                var yearCont = this.picker.find('.calendar2-years')
                                    .find('th:eq(1)')
                                    .text(year + '-' + (year + 9))
                                    .end()
                                    .find('td');
                            ...
                            showMode: function (dir) {
                                 ...
                                 */
                                //this.picker.find('>div').hide().filter('.calendar2-'+DPGlobal.modes[this.viewMode].clsName).show();
                                this.picker.find('>div').hide().filter('.calendar2-' + DPGlobal.modes[this.viewMode].clsName).css('display', 'block');
                                this.updateNavArrows();
                            },
                        ...
                        DPGlobal.template = '<div class="calendar2">' +
                            '<div class="calendar2-minutes">' +

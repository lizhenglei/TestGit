...
// color set 3 -----------------------------------------------------------------------------
#define DO_BACK_COLOR               [UIColor clearColor]//DO_RGB(232, 229, 222)

// button background color
#define DO_BUTTON_COLOR             [UIColor clearColor]//DO_RGB(158, 132, 103)
#define DO_CANCEL_COLOR             [UIColor clearColor]//DO_RGB(240, 185, 103)
#define DO_DESTRUCTIVE_COLOR        [UIColor clearColor]//DO_RGB(124, 192, 134)

// button text color
#define DO_TITLE_TEXT_COLOR         DO_RGB(95, 74, 50)
#define DO_BUTTON_TEXT_COLOR        DO_RGB(45, 116, 186)//DO_RGB(11, 106, 179) //[UIColor blueColor]
#define DO_CANCEL_TEXT_COLOR        DO_RGB(45, 116, 186)//DO_RGB(255, 255, 255)
#define DO_DESTRUCTIVE_TEXT_COLOR   DO_RGB(255, 255, 255)



#define DO_DIMMED_COLOR         DO_RGBA(0, 0, 0, 0.7) //[UIColor clearColor]

#define DO_TITLE_FONT           [UIFont fontWithName:@"Avenir-Heavy" size:16]
#define DO_BUTTON_FONT          [UIFont fontWithName:@"Avenir-Medium" size:16]

#define DO_TITLE_INSET          UIEdgeInsetsMake(10, 20, 10, 20)
#define DO_BUTTON_INSET         UIEdgeInsetsMake(5, 20, 5, 20)

#define DO_BUTTON_HEIGHT        69/2
...
@interface DoActionSheet : UIView <MAMapViewDelegate>
{
@private
    NSString                *_strTitle;
    NSString                *_strCancel;

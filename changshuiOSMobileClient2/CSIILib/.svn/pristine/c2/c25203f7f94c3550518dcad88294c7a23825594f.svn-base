...
- (void)hide:(BOOL)animated {
	useAnimation = animated;
    //added by liangsuhua 2013.10.20
...
#pragma mark - set show TimeOut
//added by liangsuhua  2013.10.20
-(void)setShowTimeOut:(NSTimeInterval)interval
{
    [NSObject cancelPreviousPerformRequestsWithTarget:self selector:@selector(handleShowTimeOut) object:nil];//取消可能存在的遮罩层超时异步请求。
    
    [self performSelector:@selector(handleShowTimeOut) withObject:nil afterDelay:interval];
}

-(void)handleShowTimeOut
{

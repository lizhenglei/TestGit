...
@interface ZXingWidgetController : UIViewController<DecoderDelegate,
  ...
  NSArray *skinTabImageSelectArray;
  NSString *skinSaoString;
#if HAS_AVFF
...
@property(nonatomic,strong)NSString *skinChangeType;
...
- (id)initWithDelegate:(id<ZXingDelegate>)scanDelegate showCancel:(BOOL)shouldShowCancel OneDMode:(BOOL)shouldUseoOneDMode showLicense:(BOOL)shouldShowLicense changeType:(NSString *)changeType;
...
- (void)zxingControllerDidCancel:(ZXingWidgetController*)controller and:(int)num;
@end
